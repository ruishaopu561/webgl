...
function main() {
    ...
    document.onkeydown = function(env){ keydown(env, gl, n, u_MvpMatrix, mvpMatrix); }
...
var eye_x = 3, eye_y = 3, step = 0.1;
function keydown(env, gl, n, u_MvpMatrix, mvpMatrix) {
    switch (env.keyCode) {
...
function draw(gl, n, u_MvpMatrix, mvpMatrix) {
    ...
    mvpMatrix.lookAt(eye_x, eye_y, 7, 0, 0, 0, 0, 1, 0);
